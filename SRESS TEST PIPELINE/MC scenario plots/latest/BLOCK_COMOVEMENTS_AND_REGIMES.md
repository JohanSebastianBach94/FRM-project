...
- [SEVERITY_SHARE_BREAKDOWN__ALL_ISOS__adverse.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ALL_ISOS__adverse.csv)
- [SEVERITY_SHARE_BREAKDOWN__ALL_ISOS__severe.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ALL_ISOS__severe.csv)
- [SEVERITY_SHARE_BREAKDOWN__ALL_ISOS__crisis.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ALL_ISOS__crisis.csv)

![severity share cake](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_CAKE__ALL_ISOS.png)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__DEU__DEU_GDP_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_GDP_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_GDP_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_GDP_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_GDP_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_GDP_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_GDP_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__DEU__DEU_UNRATE_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_UNRATE_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_UNRATE_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_UNRATE_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_UNRATE_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_UNRATE_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEU_UNRATE_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__DEU__DEUCPIALLMINMEI.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEUCPIALLMINMEI__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEUCPIALLMINMEI__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEUCPIALLMINMEI__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEUCPIALLMINMEI__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__DEU__DEUCPIALLMINMEI__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__DEU__DEUCPIALLMINMEI__crisis.csv)
...
Breakdowns (full list; includes "Other"):
- [SEVERITY_SHARE_BREAKDOWN__DEU__adverse.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__DEU__adverse.csv)
- [SEVERITY_SHARE_BREAKDOWN__DEU__severe.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__DEU__severe.csv)
- [SEVERITY_SHARE_BREAKDOWN__DEU__crisis.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__DEU__crisis.csv)

![severity share cake](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_CAKE__DEU.png)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__ESP__ESP_GDP_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_GDP_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_GDP_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_GDP_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_GDP_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_GDP_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_GDP_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__ESP__ESP_UNRATE_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_UNRATE_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_UNRATE_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_UNRATE_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_UNRATE_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_UNRATE_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESP_UNRATE_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__ESP__ESPCPIALLMINMEI.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESPCPIALLMINMEI__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESPCPIALLMINMEI__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESPCPIALLMINMEI__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESPCPIALLMINMEI__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ESP__ESPCPIALLMINMEI__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ESP__ESPCPIALLMINMEI__crisis.csv)
...
Breakdowns (full list; includes "Other"):
- [SEVERITY_SHARE_BREAKDOWN__ESP__adverse.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ESP__adverse.csv)
- [SEVERITY_SHARE_BREAKDOWN__ESP__severe.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ESP__severe.csv)
- [SEVERITY_SHARE_BREAKDOWN__ESP__crisis.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ESP__crisis.csv)

![severity share cake](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_CAKE__ESP.png)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__FRA__FRA_GDP_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_GDP_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_GDP_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_GDP_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_GDP_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_GDP_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_GDP_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__FRA__FRA_UNRATE_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_UNRATE_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_UNRATE_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_UNRATE_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_UNRATE_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_UNRATE_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRA_UNRATE_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__FRA__FRACPIALLMINMEI.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRACPIALLMINMEI__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRACPIALLMINMEI__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRACPIALLMINMEI__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRACPIALLMINMEI__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__FRA__FRACPIALLMINMEI__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__FRA__FRACPIALLMINMEI__crisis.csv)
...
Breakdowns (full list; includes "Other"):
- [SEVERITY_SHARE_BREAKDOWN__FRA__adverse.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__FRA__adverse.csv)
- [SEVERITY_SHARE_BREAKDOWN__FRA__severe.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__FRA__severe.csv)
- [SEVERITY_SHARE_BREAKDOWN__FRA__crisis.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__FRA__crisis.csv)

![severity share cake](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_CAKE__FRA.png)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__ITA__ITA_GDP_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_GDP_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_GDP_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_GDP_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_GDP_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_GDP_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_GDP_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__ITA__ITA_UNRATE_EUROSTAT.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_UNRATE_EUROSTAT__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_UNRATE_EUROSTAT__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_UNRATE_EUROSTAT__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_UNRATE_EUROSTAT__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_UNRATE_EUROSTAT__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITA_UNRATE_EUROSTAT__crisis.csv)
...
![target influence cake](TARGET%20INFLUENCE/TARGET_INFLUENCE_CAKE__ITA__ITACPIALLMINMEI.png)
Breakdowns (full list; includes "Other"):
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITACPIALLMINMEI__adverse.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITACPIALLMINMEI__adverse.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITACPIALLMINMEI__severe.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITACPIALLMINMEI__severe.csv)
- [TARGET_INFLUENCE_BREAKDOWN__ITA__ITACPIALLMINMEI__crisis.csv](TARGET%20INFLUENCE/TARGET_INFLUENCE_BREAKDOWN__ITA__ITACPIALLMINMEI__crisis.csv)
...
Breakdowns (full list; includes "Other"):
- [SEVERITY_SHARE_BREAKDOWN__ITA__adverse.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ITA__adverse.csv)
- [SEVERITY_SHARE_BREAKDOWN__ITA__severe.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ITA__severe.csv)
- [SEVERITY_SHARE_BREAKDOWN__ITA__crisis.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__ITA__crisis.csv)

![severity share cake](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_CAKE__ITA.png)
...
Breakdowns (full list; includes "Other"):
- [SEVERITY_SHARE_BREAKDOWN__USA__adverse.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__USA__adverse.csv)
- [SEVERITY_SHARE_BREAKDOWN__USA__severe.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__USA__severe.csv)
- [SEVERITY_SHARE_BREAKDOWN__USA__crisis.csv](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_BREAKDOWN__USA__crisis.csv)

![severity share cake](SEVERITY%20SHARE%20CAKES/SEVERITY_SHARE_CAKE__USA.png)
