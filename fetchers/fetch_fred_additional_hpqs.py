"""Fetch BIS FRED property-price series (copied into `fetchers/`).

This file is the same fetcher used previously but adapted to run from `fetchers/`.
It writes CSV + PNG to the project's `DCC GARCH MODEL/heatmaps_final/...` output folder.
"""
from pathlib import Path
from datetime import datetime
import os

# When running from `fetchers/`, locate the project root and then the DCC GARCH MODEL folder
